...
namespace ICELauncher.Windows
{
    ...
    public partial class ErrorWindow : MetroWindow
    {
        ...
        {
            System.Diagnostics.Process.Start("mailto:icetebe@qq.com");
        }

        //作者qq点击后
        private void Hyperlink_Click_1(object sender, RoutedEventArgs e)
        {
            System.Diagnostics.Process.Start("http://wpa.qq.com/msgrd?v=3&uin=2821258414&site=qq&menu=yes");
        }
        ...
        private void CopyButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            this.ShowMessageAsync("复制成功", "你现在可以点击窗口左下角服主联系方式，并把这该死的错误抛给他");
        }
